#Based on: https://github.com/archinetai/audio-diffusion-pytorch
...
class KDiffusion_mod(Diffusion):
    ...
    def forward(self, x: Tensor, noise: Tensor = None, **kwargs) -> Tensor:
        ...
        #here need to use different losses for different informatin
        #x,y,z is just MSE
        #neighbor numbers are just encodings 
