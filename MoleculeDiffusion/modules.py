...
class DownsampleBlock1d(nn.Module):
    def __init__(
        ...
        *,
        ...
        pre_transformer=0,#layers of self-attention 
    ):
        super().__init__()
        ...
        if self.pre_transformer>0:
            ...
            self.pre_transformer_block = Transformer1d(
                num_layers=pre_transformer,
                channels=channels,
...
class UpsampleBlock1d(nn.Module):
    ...
    def forward(
        ...
        *,
        ...
        ####################################################
        if self.pre_transformer>0: 
            x = self.pre_transformer_block(x) #
        ####################################################            
...
class UNet1d(nn.Module):
    def __init__(
        ...
        context_embedding_features: Optional[int] = None,
        pre_transformer=0,#number of self attention pre-transformer layers before unet begins
        **kwargs,
    ):
        super().__init__()
